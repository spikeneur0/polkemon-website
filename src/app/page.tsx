  ...
  return (
    <div>
      ...
      <section className="relative bg-gradient-to-b from-accent to-background">
        <div className="mx-auto flex max-w-7xl flex-col items-center px-4 py-20 text-center sm:px-6 sm:py-28 lg:px-8 lg:py-36">
          <Image
            src="/logo.png"
            alt={SITE_NAME}
            width={80}
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link
              href="/about"
              className="inline-flex items-center rounded-md border border-border px-8 py-3 text-sm font-medium transition-colors hover:bg-accent"
            >
              About Us
            </Link>
          </div>
