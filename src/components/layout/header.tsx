...
const MEGA_MENU_GROUPS = [
  ...
  {
    label: "More",
    slugs: ["supplies", "food-drink", "other"],
  },
] as const;
...
export function Header() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 border-b border-border backdrop-blur supports-[backdrop-filter]:bg-[#F6F0E6]/90" style={{ backgroundColor: "#F6F0E6" }}>
